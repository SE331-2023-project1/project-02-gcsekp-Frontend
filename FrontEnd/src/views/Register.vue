        ...
        <div>
          ...
          <div class="mt-2">
            <input
              ...
              required
              class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6"
            />
          </div>
        </div>
        <div>
...
export default {
  ...
  methods: {
    sendPost() {
      ...
      axios
        .post('http://localhost:8080/api/v1/auth/register', postData)
        .then((res) => {
